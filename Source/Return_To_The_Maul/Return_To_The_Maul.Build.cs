...
public class Return_To_The_Maul : ModuleRules
{
	...
	{
		PrivateDependencyModuleNames.AddRange(new string[] { "SupportFunctions", "RTSPlayerController", "SimpleUIManager", "RTSToolkitInterfaces", "RTSEconomySystem", "RTSGamemode", "SimpleMenuSystem" });
